...
if(isset($_POST['submitThis']) && $_POST['submitThis'] == "Submit")
	...
	echo articlePositionsModel::submitInstitution($_POST);
	...
	if(isset($itemId) && $itemId > 0)
		$inst = articlePositionsModel::articlePositionDetails($itemId);
	...
	?>
		...
		<form action="" method="post" novalidate>
			...
			<?php
            if(isset($itemId) && $itemId > 0)
				echo '<input type="hidden" name="articlePositionid" value="'.$itemId.'" />';
			?>
